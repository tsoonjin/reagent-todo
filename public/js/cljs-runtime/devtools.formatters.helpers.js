...
var G__28464 = devtools.prefs.pref(v);
v = G__28464;
continue;
} else {
return v;
...
}catch (e28432){var _e__27814__auto__ = e28432;
return false;
}})();
...
}catch (e28436){var _e__27814__auto__ = e28436;
return false;
}})();
...
}catch (e28438){var _e__27814__auto__ = e28438;
return false;
}}
}
});
...
var vec__28448 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28448,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28448,(1),null);
...
return cljs.core.some((function (p1__28455_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28455_SHARP_);
}),template);
});
