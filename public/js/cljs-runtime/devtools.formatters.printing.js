...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28493){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28494,G__28495,seq28493__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28510_SHARP_){
return (!((cljs.core.meta(p1__28510_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28518__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28523){var _e__27814__auto__ = e28523;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28525){var _e__27814__auto__ = e28525;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28531 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28532 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28532);

try{var map__28536 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28536__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28531);
}});
...
var _STAR_print_level_STAR__orig_val__28539_28564 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28540_28565 = managed_print_level_28563;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28540_28565);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28538_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28538_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28539_28564);
}} else {
job_fn();
}
