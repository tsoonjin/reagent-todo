...
var o28204 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28204["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28205 = temp__5733__auto____$1;
return (o28205["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27781__auto__ = f;
return (o__27781__auto__["toString"]).call(o__27781__auto__);
} else {
return "";
}
}catch (e28209){var _ = e28209;
return "";
}});
...
try{var o__27781__auto___28427 = t;
(o__27781__auto___28427["cljs$lang$ctorPrWriter"]).call(o__27781__auto___28427,t,writer);
}catch (e28217){var __28428 = e28217;
}
...
var char_code = (function (){var o__27781__auto__ = (new String(char$));
return (o__27781__auto__["charCodeAt"]).call(o__27781__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27781__auto__ = String;
return (o__27781__auto__["fromCharCode"]).call(o__27781__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28226 = num_code;
switch (G__28226) {
case (1):
return (185);
...
var o__27781__auto__ = String;
return (o__27781__auto__["fromCharCode"]).call(o__27781__auto__,superscript_code);
});
/**
...
}catch (e28233){var _e__27814__auto__ = e28233;
return false;
}})())){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28259){
var vec__28260 = p__28259;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28260,(0),null);
...
var G__28446 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28447 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28446;
remaining_tokens = G__28447;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28256){
var G__28257 = cljs.core.first(seq28256);
var seq28256__$1 = cljs.core.next(seq28256);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28257,seq28256__$1);
}));
...
var vec__28274 = cljs.core.split_with((function (p1__28271_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28271_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(1),null);
...
var vec__28282 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28282,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28282,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28453 = cljs.core.rest(remaining_tokens);
var G__28454 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28453;
name_tokens = G__28454;
continue;
} else {
...
var vec__28295 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28295,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28295,(1),null);
var vec__28298 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28298,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28298,(1),null);
var vec__28301 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(3),null);
...
var vec__28312 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28312,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28316 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28316,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28316,(1),null);
var vec__28322 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28322,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28322,(1),null);
...
var G__28496 = (arity + (1));
var G__28497 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28344){
var vec__28345 = p__28344;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28345,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28345,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28354_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28355_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28355_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28364){
var vec__28365 = p__28364;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28365,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28359){
var G__28360 = cljs.core.first(seq28359);
var seq28359__$1 = cljs.core.next(seq28359);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28360,seq28359__$1);
}));
...
var map__28379 = options;
var map__28379__$1 = (((((!((map__28379 == null))))?(((((map__28379.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28379.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28379):map__28379);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28379__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28379__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28379__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28379__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28380 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(5),null);
...
var o__27781__auto__ = f;
return (o__27781__auto__["getBasis"]).call(o__27781__auto__);
});
/**
...
}catch (e28384){var _e__27814__auto__ = e28384;
...
var G__28528 = (obj[cljs.core.first(path)]);
var G__28529 = cljs.core.rest(path);
obj = G__28528;
path = G__28529;
continue;
} else {
...
var _STAR_ = (function (accum,p__28400){
var vec__28401 = p__28400;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28401,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28401,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28405){
var vec__28406 = p__28405;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28406,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28406,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28406,(2),null);
...
var post_process = (function (p__28414){
var vec__28415 = p__28414;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28415,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28415,(1),null);
...
return (obj[cljs.core.first(p1__28413_SHARP_)]);
}),sorted_matches);
