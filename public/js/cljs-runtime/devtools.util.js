...
var _STAR_print_newline_STAR__orig_val__29489_29638 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29490_29639 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29491_29640 = true;
var _STAR_print_fn_STAR__temp_val__29492_29641 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29491_29640);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29492_29641);

try{var _STAR_print_level_STAR__orig_val__29493_29642 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29494_29643 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29494_29643);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29493_29642);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29490_29639);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29489_29638);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq29480){
...
var new_formatters = current_formatters.filter((function (p1__29559_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__29559_SHARP_)));
}));
...
var G__29567_29666 = f;
var target__27804__auto___29667 = G__29567_29666;
if(cljs.core.truth_(target__27804__auto___29667)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29567_29666)].join(''),"\n","target__27804__auto__"].join('')));
}

(target__27804__auto___29667["toString"] = (function (){
...
var G__29573_29668 = "%c%s";
var G__29574_29669 = "color:transparent";
var G__29575_29670 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__29573_29668,G__29574_29669,G__29575_29670) : f.call(null,G__29573_29668,G__29574_29669,G__29575_29670));
...
var vec__29585 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29585,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29585,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__29683__delegate = function (add_fmt,add_args){
...
var G__29683 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__29685__i = 0, G__29685__a = new Array(arguments.length -  1);
while (G__29685__i < G__29685__a.length) {G__29685__a[G__29685__i] = arguments[G__29685__i + 1]; ++G__29685__i;}
  add_args = new cljs.core.IndexedSeq(G__29685__a,0,null);
} 
return G__29683__delegate.call(this,add_fmt,add_args);};
G__29683.cljs$lang$maxFixedArity = 1;
G__29683.cljs$lang$applyTo = (function (arglist__29686){
var add_fmt = cljs.core.first(arglist__29686);
var add_args = cljs.core.rest(arglist__29686);
return G__29683__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq29577){
...
var G__29580 = cljs.core.first(seq29577__$2);
var seq29577__$3 = cljs.core.next(seq29577__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29578,G__29579,G__29580,seq29577__$3);
}));
...
var seq__29599 = cljs.core.seq(features);
var chunk__29600 = null;
var count__29601 = (0);
var i__29602 = (0);
while(true){
if((i__29602 < count__29601)){
var feature = chunk__29600.cljs$core$IIndexed$_nth$arity$2(null,i__29602);
...
var G__29691 = seq__29599;
var G__29692 = chunk__29600;
var G__29693 = count__29601;
var G__29694 = (i__29602 + (1));
seq__29599 = G__29691;
chunk__29600 = G__29692;
count__29601 = G__29693;
i__29602 = G__29694;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__29599);
if(temp__5735__auto__){
var seq__29599__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__29599__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__29599__$1);
var G__29697 = cljs.core.chunk_rest(seq__29599__$1);
var G__29698 = c__4556__auto__;
var G__29699 = cljs.core.count(c__4556__auto__);
var G__29700 = (0);
seq__29599 = G__29697;
chunk__29600 = G__29698;
count__29601 = G__29699;
i__29602 = G__29700;
continue;
} else {
var feature = cljs.core.first(seq__29599__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29704 = cljs.core.next(seq__29599__$1);
var G__29705 = null;
var G__29706 = (0);
var G__29707 = (0);
seq__29599 = G__29704;
chunk__29600 = G__29705;
count__29601 = G__29706;
i__29602 = G__29707;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29622 = temp__5733__auto__;
return (o29622["version"]);
} else {
return null;
}
})() == null);
